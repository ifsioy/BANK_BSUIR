...
class Enterprise:
    def __init__(self, enterprise_type: EnterpriseType, legal_name: str, unp: str, bank_bic: str, legal_address: str):
    ...
    def __str__(self):
        return (f"Enterprise(type={self.enterprise_type.value}, "
